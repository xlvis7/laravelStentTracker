...
INSERT INTO `users` (`username`, `password`, `first_name`, `last_name`, `email`, `active`, `role`) VALUES
('Student1', '5f4dcc3b5aa765d61d8327deb882cf99', 'Ram', 'Gopal Raj', 'ram_prime@fsktm.um.edu.my', 1, 'student');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `Matric_Number` varchar(32),
  `Hand_Phone_Number` varchar(32),
  `Kolej_Kediaman` varchar(32),
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;


INSERT INTO `users` (`user_id`, `username`, `password`, `first_name`, `last_name`, `email`, `active`, `role`, `Title`, `IC_Number`, `Matric_Number`, `Hand_Phone_Number`, `Kolej_Kediaman`) VALUES
(1, 'Ram', '5f4dcc3b5aa765d61d8327deb882cf99', 'Ram', 'Gopal Raj', 'ram_prime@fsktm.um.edu.my', 1, 'administrator' 'Dr.', null, null, null, null);
...
4.	Email Address
5.	Hand Phone Number 
6.	Kolej Kediaman (Residential College)
7.	Catatan (Notes), Attendance Confirmed? (Yes/No)
8.	Actual Attendance (Yes/No)
9.	Merit Points Awarded(5 points) 
10.	List of Programs (RSS will get 20 merits)
11.	Rank according to program (BLISS Mental Health)
12.	Student Year (Current)
13.	CGPA (2 decimal Point Precision)
*/
